...
def pre_condition(b:sympy.Rational,delta:sympy.Rational):
    ...
    #(2*b + delta > 1) & (b**2 + delta - 2 >= 0) & (-b**2 + delta + 2 >= 0)



    pre_cond = And(StrictGreaterThan(Add(Mul(Integer(2), Symbol('b')), Symbol('delta')), Integer(1)), GreaterThan(Add(Pow(Symbol('b'), Integer(2)), Symbol('delta'), Integer(-2)), Integer(0)), GreaterThan(Add(Mul(Integer(-1), Pow(Symbol('b'), Integer(2))), Symbol('delta'), Integer(2)), Integer(0)))
