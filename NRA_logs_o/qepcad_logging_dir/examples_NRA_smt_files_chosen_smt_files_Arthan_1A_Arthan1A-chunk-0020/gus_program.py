...
if pre_condition(delta=delta_i,skoS=skoS_i,pi=pi_i)==False:
    ...
    _let_1 = (skoS_i * skoS_i)
    if ((delta_i >= 0) and (skoS_i >= 0) and not ((((1) * pi_i) >= ((15707963) / 5000000))) and not ((pi_i >= (31415927 / 10000000))) and not (((skoS_i + (((1) / 2) * pi_i)) >= 0)) and not ((skoS_i >= (1))) and (not (((delta_i + ((1) * _let_1)) >= (1))) or not (((delta_i + _let_1) >= 1)))):
        skoCOSS_o =  (1 / 2)
    else:
        skoCOSS_o =  0.0
    _let_1 = (skoS_i * skoS_i)
    if ((delta_i >= 0) and (skoS_i >= 0) and not ((((1) * pi_i) >= ((15707963) / 5000000))) and not ((pi_i >= (31415927 / 10000000))) and not (((skoS_i + (((1) / 2) * pi_i)) >= 0)) and not ((skoS_i >= (1)))):
        if (((delta_i + ((1) * _let_1)) >= (1)) and ((delta_i + _let_1) >= 1)):
            skoSINS_o =  skoS_i
        else:
            skoSINS_o =  (2.0)
    else:
