...
def pre_condition_0(delta:sympy.Rational,skoS:sympy.Rational):
	...
	pre_cond = And(GreaterThan(Symbol('delta'), Integer(0)), GreaterThan(Symbol('skoS'), Rational(9, 20)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('skoSINS'), Integer(2)), Rational(-63, 64))), GreaterThan(Symbol('delta'), Add(Rational(63, 64), Mul(Integer(-1), Pow(Symbol('skoSINS'), Integer(2))))))
...
def pre_condition_1(delta:sympy.Rational,skoS:sympy.Rational):
	#(delta >= 47/64) & (skoS >= 9/20)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(47, 64)), GreaterThan(Symbol('skoS'), Rational(9, 20)))
...
def pre_condition_2(delta:sympy.Rational,skoS:sympy.Rational):
	...
	pre_cond = And(GreaterThan(Symbol('delta'), Integer(0)), GreaterThan(Symbol('skoS'), Rational(9, 20)), GreaterThan(Symbol('delta'), Pow(Symbol('skoSINS'), Integer(2))), GreaterThan(Symbol('delta'), Mul(Integer(-1), Pow(Symbol('skoSINS'), Integer(2)))))
...
def pre_condition_3(delta:sympy.Rational,skoS:sympy.Rational):
	#(delta >= 1/64) & (skoS >= 9/20)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(1, 64)), GreaterThan(Symbol('skoS'), Rational(9, 20)))
...
def pre_condition_4(delta:sympy.Rational,skoS:sympy.Rational):
	#(delta >= 0) & (skoS >= 9/20) & (delta >= skoSINS**2 - 255/256) & (delta >= 255/256 - skoSINS**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Integer(0)), GreaterThan(Symbol('skoS'), Rational(9, 20)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('skoSINS'), Integer(2)), Rational(-255, 256))), GreaterThan(Symbol('delta'), Add(Rational(255, 256), Mul(Integer(-1), Pow(Symbol('skoSINS'), Integer(2))))))
...
def pre_condition_5(delta:sympy.Rational,skoS:sympy.Rational):
	#(delta >= 1/256) & (skoS >= 9/20)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(1, 256)), GreaterThan(Symbol('skoS'), Rational(9, 20)))
...
def pre_condition_6(delta:sympy.Rational,skoS:sympy.Rational):
	#(delta >= 0) & (skoS >= 9/20) & (delta >= skoSINS**2 - 4129279/4194304) & (delta >= 4129279/4194304 - skoSINS**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Integer(0)), GreaterThan(Symbol('skoS'), Rational(9, 20)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('skoSINS'), Integer(2)), Rational(-4129279, 4194304))), GreaterThan(Symbol('delta'), Add(Rational(4129279, 4194304), Mul(Integer(-1), Pow(Symbol('skoSINS'), Integer(2))))))
...
def pre_condition_7(delta:sympy.Rational,skoS:sympy.Rational):
	#(delta >= 255/4194304) & (skoS >= 9/20)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(255, 4194304)), GreaterThan(Symbol('skoS'), Rational(9, 20)))
