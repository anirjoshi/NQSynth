...
def pre_condition_0(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 1) & (b > 0) & (delta >= b**2 - 2) & (delta >= 2 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Integer(1)), StrictGreaterThan(Symbol('b'), Integer(0)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-2))), GreaterThan(Symbol('delta'), Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_1(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 0) & (b > 1/2) & (delta >= b**2 - 2) & (delta >= 2 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Integer(0)), StrictGreaterThan(Symbol('b'), Rational(1, 2)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-2))), GreaterThan(Symbol('delta'), Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_2(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 2) & (b > -1/2) & (delta >= b**2 - 2) & (delta >= 2 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Integer(2)), StrictGreaterThan(Symbol('b'), Rational(-1, 2)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-2))), GreaterThan(Symbol('delta'), Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_3(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 7/4) & (b > -3/8) & (delta >= b**2 - 2) & (delta >= 2 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(7, 4)), StrictGreaterThan(Symbol('b'), Rational(-3, 8)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-2))), GreaterThan(Symbol('delta'), Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_4(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 23/12) & (b > -11/24) & (delta >= b**2 - 2) & (delta >= 2 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(23, 12)), StrictGreaterThan(Symbol('b'), Rational(-11, 24)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-2))), GreaterThan(Symbol('delta'), Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def post_condition(b:sympy.Rational, delta:sympy.Rational, a:sympy.Rational):
	# (0 <= delta) & (b > a) & (1 - 2*a <= delta) & (2*a - 1 <= delta) & (b**2 - 2 <= delta) & (2 - b**2 <= delta)

	post_cond =  And(LessThan(Integer(0), Symbol('delta')), StrictGreaterThan(Symbol('b'), Symbol('a')), LessThan(Add(Integer(1), Mul(Integer(-1), Integer(2), Symbol('a'))), Symbol('delta')), LessThan(Add(Mul(Integer(2), Symbol('a')), Integer(-1)), Symbol('delta')), LessThan(Add(Pow(Symbol('b'), Integer(2)), Integer(-2)), Symbol('delta')), LessThan(Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(2)))), Symbol('delta')))
