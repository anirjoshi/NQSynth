...
def pre_condition_0(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 127/64) & (b < 1/8) & (delta >= b**2 - 3) & (delta >= 3 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(127, 64)), StrictLessThan(Symbol('b'), Rational(1, 8)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_1(b:sympy.Rational,delta:sympy.Rational):
	...
	pre_cond = And(GreaterThan(Symbol('delta'), Integer(1)), StrictLessThan(Symbol('b'), Integer(1)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_2(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 79/100) & (b < -11/10) & (delta >= b**2 - 3) & (delta >= 3 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(79, 100)), StrictLessThan(Symbol('b'), Rational(-11, 10)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_3(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 1/4) & (b < -3/2) & (delta >= b**2 - 3) & (delta >= 3 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(1, 4)), StrictLessThan(Symbol('b'), Rational(-3, 2)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_4(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 7/64) & (b < -11/8) & (delta >= b**2 - 3) & (delta >= 3 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(7, 64)), StrictLessThan(Symbol('b'), Rational(-11, 8)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_5(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 17/256) & (b < -23/16) & (delta >= b**2 - 3) & (delta >= 3 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(17, 256)), StrictLessThan(Symbol('b'), Rational(-23, 16)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_6(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 23/1024) & (b < -45/32) & (delta >= b**2 - 3) & (delta >= 3 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(23, 1024)), StrictLessThan(Symbol('b'), Rational(-45, 32)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_7(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 89/4096) & (b < -91/64) & (delta >= b**2 - 3) & (delta >= 3 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(89, 4096)), StrictLessThan(Symbol('b'), Rational(-91, 64)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_8(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 7/16384) & (b < -181/128) & (delta >= b**2 - 3) & (delta >= 3 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(7, 16384)), StrictLessThan(Symbol('b'), Rational(-181, 128)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_9(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 4417/16777216) & (b < -5793/4096) & (delta >= b**2 - 3) & (delta >= 3 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(4417, 16777216)), StrictLessThan(Symbol('b'), Rational(-5793, 4096)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def post_condition(b:sympy.Rational, delta:sympy.Rational, a:sympy.Rational):
	# (0 <= delta) & (b < a) & (a**2 - 2 <= delta) & (b**2 - 3 <= delta) & (2 - a**2 <= delta) & (3 - b**2 <= delta)

	post_cond =  And(LessThan(Integer(0), Symbol('delta')), StrictLessThan(Symbol('b'), Symbol('a')), LessThan(Add(Pow(Symbol('a'), Integer(2)), Integer(-2)), Symbol('delta')), LessThan(Add(Pow(Symbol('b'), Integer(2)), Integer(-3)), Symbol('delta')), LessThan(Add(Integer(2), Mul(Integer(-1), Pow(Symbol('a'), Integer(2)))), Symbol('delta')), LessThan(Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2)))), Symbol('delta')))
