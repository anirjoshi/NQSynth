...
def pre_condition_0(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 1) & (b < 1) & (delta >= b**2 - 2) & (delta >= 2 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Integer(1)), StrictLessThan(Symbol('b'), Integer(1)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-2))), GreaterThan(Symbol('delta'), Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_1(b:sympy.Rational,delta:sympy.Rational):
	...
	pre_cond = And(GreaterThan(Symbol('delta'), Integer(0)), StrictLessThan(Symbol('b'), Rational(1, 2)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-2))), GreaterThan(Symbol('delta'), Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_2(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 3) & (b < 2) & (delta >= b**2 - 2) & (delta >= 2 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Integer(3)), StrictLessThan(Symbol('b'), Integer(2)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-2))), GreaterThan(Symbol('delta'), Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_3(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 7/3) & (b < 5/3) & (delta >= b**2 - 2) & (delta >= 2 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(7, 3)), StrictLessThan(Symbol('b'), Rational(5, 3)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-2))), GreaterThan(Symbol('delta'), Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def post_condition(b:sympy.Rational, delta:sympy.Rational, a:sympy.Rational):
	...
	post_cond =  And(LessThan(Integer(0), Symbol('delta')), StrictLessThan(Symbol('b'), Symbol('a')), LessThan(Add(Integer(1), Mul(Integer(-1), Integer(2), Symbol('a'))), Symbol('delta')), LessThan(Add(Mul(Integer(2), Symbol('a')), Integer(-1)), Symbol('delta')), LessThan(Add(Pow(Symbol('b'), Integer(2)), Integer(-2)), Symbol('delta')), LessThan(Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(2)))), Symbol('delta')))
