...
def pre_condition_0(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 127/64) & (delta >= b**2 - 3) & (delta >= 3 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(127, 64)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_1(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 1) & (delta >= b**2 - 3) & (delta >= 3 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Integer(1)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_2(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 1/4) & (delta >= b**2 - 3) & (delta >= 3 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(1, 4)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_3(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 7/64) & (delta >= b**2 - 3) & (delta >= 3 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(7, 64)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_4(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 17/256) & (delta >= b**2 - 3) & (delta >= 3 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(17, 256)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_5(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 23/1024) & (delta >= b**2 - 3) & (delta >= 3 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(23, 1024)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_6(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 89/4096) & (delta >= b**2 - 3) & (delta >= 3 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(89, 4096)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_7(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 7/16384) & (delta >= b**2 - 3) & (delta >= 3 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(7, 16384)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_8(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 4417/16777216) & (delta >= b**2 - 3) & (delta >= 3 - b**2)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(4417, 16777216)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(2)), Integer(-3))), GreaterThan(Symbol('delta'), Add(Integer(3), Mul(Integer(-1), Pow(Symbol('b'), Integer(2))))))
...
def pre_condition_597(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 4417/16777216) & (delta >= b**2 - 3) & (delta >= 3 - b**2)
...
def post_condition(b:sympy.Rational, delta:sympy.Rational, a:sympy.Rational):
	# (0 <= delta) & (a**2 - 2 <= delta) & (b**2 - 3 <= delta) & (2 - a**2 <= delta) & (3 - b**2 <= delta)
...
if __name__=="__main__":
	...
	if pre_condition_597(b=b,delta=delta)==True:
