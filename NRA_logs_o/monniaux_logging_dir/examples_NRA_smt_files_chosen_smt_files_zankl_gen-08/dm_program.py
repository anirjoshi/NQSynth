...
def pre_condition_0(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 2) & (b < 2) & (delta >= b**3 - 2) & (delta >= 2 - b**3)

	pre_cond = And(GreaterThan(Symbol('delta'), Integer(2)), StrictLessThan(Symbol('b'), Integer(2)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(3)), Integer(-2))), GreaterThan(Symbol('delta'), Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(3))))))
...
def pre_condition_1(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 1/4) & (b < 3/2) & (delta >= b**3 - 2) & (delta >= 2 - b**3)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(1, 4)), StrictLessThan(Symbol('b'), Rational(3, 2)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(3)), Integer(-2))), GreaterThan(Symbol('delta'), Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(3))))))
...
def pre_condition_2(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 7/64) & (b < 11/8) & (delta >= b**3 - 2) & (delta >= 2 - b**3)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(7, 64)), StrictLessThan(Symbol('b'), Rational(11, 8)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(3)), Integer(-2))), GreaterThan(Symbol('delta'), Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(3))))))
...
def pre_condition_3(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 17/256) & (b < 23/16) & (delta >= b**3 - 2) & (delta >= 2 - b**3)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(17, 256)), StrictLessThan(Symbol('b'), Rational(23, 16)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(3)), Integer(-2))), GreaterThan(Symbol('delta'), Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(3))))))
...
def pre_condition_4(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 23/1024) & (b < 45/32) & (delta >= b**3 - 2) & (delta >= 2 - b**3)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(23, 1024)), StrictLessThan(Symbol('b'), Rational(45, 32)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(3)), Integer(-2))), GreaterThan(Symbol('delta'), Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(3))))))
...
def pre_condition_5(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 89/4096) & (b < 91/64) & (delta >= b**3 - 2) & (delta >= 2 - b**3)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(89, 4096)), StrictLessThan(Symbol('b'), Rational(91, 64)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(3)), Integer(-2))), GreaterThan(Symbol('delta'), Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(3))))))
...
def pre_condition_6(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 7/16384) & (b < 181/128) & (delta >= b**3 - 2) & (delta >= 2 - b**3)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(7, 16384)), StrictLessThan(Symbol('b'), Rational(181, 128)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(3)), Integer(-2))), GreaterThan(Symbol('delta'), Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(3))))))
...
def pre_condition_7(b:sympy.Rational,delta:sympy.Rational):
	#(delta >= 4417/16777216) & (b < 5793/4096) & (delta >= b**3 - 2) & (delta >= 2 - b**3)

	pre_cond = And(GreaterThan(Symbol('delta'), Rational(4417, 16777216)), StrictLessThan(Symbol('b'), Rational(5793, 4096)), GreaterThan(Symbol('delta'), Add(Pow(Symbol('b'), Integer(3)), Integer(-2))), GreaterThan(Symbol('delta'), Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(3))))))
...
def post_condition(b:sympy.Rational, delta:sympy.Rational, a:sympy.Rational):
	# (0 <= delta) & (a > b) & (a**2 - 2 <= delta) & (b**3 - 2 <= delta) & (2 - a**2 <= delta) & (2 - b**3 <= delta)

	post_cond =  And(LessThan(Integer(0), Symbol('delta')), StrictGreaterThan(Symbol('a'), Symbol('b')), LessThan(Add(Pow(Symbol('a'), Integer(2)), Integer(-2)), Symbol('delta')), LessThan(Add(Pow(Symbol('b'), Integer(3)), Integer(-2)), Symbol('delta')), LessThan(Add(Integer(2), Mul(Integer(-1), Pow(Symbol('a'), Integer(2)))), Symbol('delta')), LessThan(Add(Integer(2), Mul(Integer(-1), Pow(Symbol('b'), Integer(3)))), Symbol('delta')))
