...
def pre_condition_0(delta:sympy.Rational,skoS:sympy.Rational,pi:sympy.Rational):
	#(delta >= 0) & (5000000*pi - 15707963 > 0) & (10000000*pi - 31415927 < 0) & (-pi + 2*skoS < 0)

	pre_cond = And(GreaterThan(Symbol('delta'), Integer(0)), StrictGreaterThan(Add(Mul(Integer(5000000), Symbol('pi')), Integer(-15707963)), Integer(0)), StrictLessThan(Add(Mul(Integer(10000000), Symbol('pi')), Integer(-31415927)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('pi')), Mul(Integer(2), Symbol('skoS'))), Integer(0)))
...
def pre_condition_1(delta:sympy.Rational,skoS:sympy.Rational,pi:sympy.Rational):
	#(delta >= 0) & (5000000*pi - 15707963 > 0) & (10000000*pi - 31415927 < 0) & (-pi + 2*skoS < 0) & ((skoS + 1 > 0) | (skoS**6 + 4*skoS**5 - 12*skoS**4 + 2*skoS**3 + 92*skoS**2 + 32*skoS - 7 > 0))

	pre_cond = And(GreaterThan(Symbol('delta'), Integer(0)), StrictGreaterThan(Add(Mul(Integer(5000000), Symbol('pi')), Integer(-15707963)), Integer(0)), StrictLessThan(Add(Mul(Integer(10000000), Symbol('pi')), Integer(-31415927)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('pi')), Mul(Integer(2), Symbol('skoS'))), Integer(0)), Or(StrictGreaterThan(Add(Symbol('skoS'), Integer(1)), Integer(0)), StrictGreaterThan(Add(Pow(Symbol('skoS'), Integer(6)), Mul(Integer(4), Pow(Symbol('skoS'), Integer(5))), Mul(Integer(-1), Integer(12), Pow(Symbol('skoS'), Integer(4))), Mul(Integer(2), Pow(Symbol('skoS'), Integer(3))), Mul(Integer(92), Pow(Symbol('skoS'), Integer(2))), Mul(Integer(32), Symbol('skoS')), Integer(-7)), Integer(0))))
