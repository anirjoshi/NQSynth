...
def pre_condition_0(b:sympy.Rational,delta:sympy.Rational):
	#(b**2 + delta - 3 >= 0) & (-b**2 + delta + 3 >= 0) & ((b + 1 > 0) | (-b**2 + delta + 2 > 0))

	pre_cond = And(GreaterThan(Add(Pow(Symbol('b'), Integer(2)), Symbol('delta'), Integer(-3)), Integer(0)), GreaterThan(Add(Mul(Integer(-1), Pow(Symbol('b'), Integer(2))), Symbol('delta'), Integer(3)), Integer(0)), Or(StrictGreaterThan(Add(Symbol('b'), Integer(1)), Integer(0)), StrictGreaterThan(Add(Mul(Integer(-1), Pow(Symbol('b'), Integer(2))), Symbol('delta'), Integer(2)), Integer(0))))
