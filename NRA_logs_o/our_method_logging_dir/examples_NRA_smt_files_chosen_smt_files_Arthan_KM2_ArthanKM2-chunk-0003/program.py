...
def pre_condition_1(delta:sympy.Rational,skoS:sympy.Rational):
	#(delta >= 0) & ((skoS + 1 > 0) | (skoS**6 + 6*skoS**5 - 5*skoS**4 + 24*skoS**3 + 111*skoS**2 + 34*skoS - 7 > 0))

	pre_cond = And(GreaterThan(Symbol('delta'), Integer(0)), Or(StrictGreaterThan(Add(Symbol('skoS'), Integer(1)), Integer(0)), StrictGreaterThan(Add(Pow(Symbol('skoS'), Integer(6)), Mul(Integer(6), Pow(Symbol('skoS'), Integer(5))), Mul(Integer(-1), Integer(5), Pow(Symbol('skoS'), Integer(4))), Mul(Integer(24), Pow(Symbol('skoS'), Integer(3))), Mul(Integer(111), Pow(Symbol('skoS'), Integer(2))), Mul(Integer(34), Symbol('skoS')), Integer(-7)), Integer(0))))
...
if __name__=="__main__":
	...
	if pre_condition_0(delta=delta,skoS=skoS)==True:
		...
		all_vals['skoS'] = skoS
		all_vals['skoCOSS'] = Add(Symbol('lambda_var_0'), Integer(-6))
