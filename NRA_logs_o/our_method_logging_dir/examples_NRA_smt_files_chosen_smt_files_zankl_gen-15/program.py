...
def pre_condition_0(b:sympy.Rational,delta:sympy.Rational):
	#(b**2 + delta - 3 >= 0) & (-b**2 + delta + 3 >= 0) & ((delta - 2 > 0) | (b**2 - 2*b*delta + delta**2 - delta - 2 <= 0) | (b**2 + 2*b*delta + delta**2 - delta - 2 <= 0))

	pre_cond = And(GreaterThan(Add(Pow(Symbol('b'), Integer(2)), Symbol('delta'), Integer(-3)), Integer(0)), GreaterThan(Add(Mul(Integer(-1), Pow(Symbol('b'), Integer(2))), Symbol('delta'), Integer(3)), Integer(0)), Or(StrictGreaterThan(Add(Symbol('delta'), Integer(-2)), Integer(0)), LessThan(Add(Pow(Symbol('b'), Integer(2)), Mul(Integer(-1), Integer(2), Symbol('b'), Symbol('delta')), Pow(Symbol('delta'), Integer(2)), Mul(Integer(-1), Symbol('delta')), Integer(-2)), Integer(0)), LessThan(Add(Pow(Symbol('b'), Integer(2)), Mul(Integer(2), Symbol('b'), Symbol('delta')), Pow(Symbol('delta'), Integer(2)), Mul(Integer(-1), Symbol('delta')), Integer(-2)), Integer(0))))
...
def post_condition(b:sympy.Rational, delta:sympy.Rational, a:sympy.Rational):
	# (0 <= delta) & (-a + b <= delta) & (a - b <= delta) & (a**2 - 2 <= delta) & (b**2 - 3 <= delta) & (2 - a**2 <= delta) & (3 - b**2 <= delta)
