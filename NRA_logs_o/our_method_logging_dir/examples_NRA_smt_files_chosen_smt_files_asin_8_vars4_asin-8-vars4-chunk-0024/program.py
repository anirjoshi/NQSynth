...
def pre_condition_4(delta:sympy.Rational,skoX:sympy.Rational,skoS2:sympy.Rational):
	#(delta >= 0) & (skoS2 > 0) & (skoX > 0) & (skoX - 1 < 0) & (delta + skoS2**2 - 2 >= 0) & (1024*delta + 1024*skoX - 495 >= 0) & (-1024*delta + 1024*skoX - 495 <= 0) & (-delta + skoS2**2 - 2 <= 0)

	pre_cond = And(GreaterThan(Symbol('delta'), Integer(0)), StrictGreaterThan(Symbol('skoS2'), Integer(0)), StrictGreaterThan(Symbol('skoX'), Integer(0)), StrictLessThan(Add(Symbol('skoX'), Integer(-1)), Integer(0)), GreaterThan(Add(Symbol('delta'), Pow(Symbol('skoS2'), Integer(2)), Integer(-2)), Integer(0)), GreaterThan(Add(Mul(Integer(1024), Symbol('delta')), Mul(Integer(1024), Symbol('skoX')), Integer(-495)), Integer(0)), LessThan(Add(Mul(Integer(-1), Integer(1024), Symbol('delta')), Mul(Integer(1024), Symbol('skoX')), Integer(-495)), Integer(0)), LessThan(Add(Mul(Integer(-1), Symbol('delta')), Pow(Symbol('skoS2'), Integer(2)), Integer(-2)), Integer(0)))
...
def pre_condition_18(delta:sympy.Rational,skoX:sympy.Rational,skoS2:sympy.Rational):
	#(delta >= 0) & (skoS2 > 0) & (skoX > 0) & (skoX - 1 < 0) & (delta + skoS2**2 - 2 >= 0) & (262144*delta + 262144*skoX - 262143 >= 0) & (-262144*delta + 262144*skoX - 262143 <= 0) & (-delta + skoS2**2 - 2 <= 0)

	pre_cond = And(GreaterThan(Symbol('delta'), Integer(0)), StrictGreaterThan(Symbol('skoS2'), Integer(0)), StrictGreaterThan(Symbol('skoX'), Integer(0)), StrictLessThan(Add(Symbol('skoX'), Integer(-1)), Integer(0)), GreaterThan(Add(Symbol('delta'), Pow(Symbol('skoS2'), Integer(2)), Integer(-2)), Integer(0)), GreaterThan(Add(Mul(Integer(262144), Symbol('delta')), Mul(Integer(262144), Symbol('skoX')), Integer(-262143)), Integer(0)), LessThan(Add(Mul(Integer(-1), Integer(262144), Symbol('delta')), Mul(Integer(262144), Symbol('skoX')), Integer(-262143)), Integer(0)), LessThan(Add(Mul(Integer(-1), Symbol('delta')), Pow(Symbol('skoS2'), Integer(2)), Integer(-2)), Integer(0)))
...
def pre_condition_19(delta:sympy.Rational,skoX:sympy.Rational,skoS2:sympy.Rational):
	#(delta >= 0) & (skoS2 > 0) & (skoX > 0) & (skoX - 1 < 0) & (delta + skoS2**2 - 2 >= 0) & (68719476736*delta + 68719476736*skoX - 68719031793 >= 0) & (-68719476736*delta + 68719476736*skoX - 68719031793 <= 0) & (-delta + skoS2**2 - 2 <= 0)

	pre_cond = And(GreaterThan(Symbol('delta'), Integer(0)), StrictGreaterThan(Symbol('skoS2'), Integer(0)), StrictGreaterThan(Symbol('skoX'), Integer(0)), StrictLessThan(Add(Symbol('skoX'), Integer(-1)), Integer(0)), GreaterThan(Add(Symbol('delta'), Pow(Symbol('skoS2'), Integer(2)), Integer(-2)), Integer(0)), GreaterThan(Add(Mul(Integer(68719476736), Symbol('delta')), Mul(Integer(68719476736), Symbol('skoX')), Integer(-68719031793)), Integer(0)), LessThan(Add(Mul(Integer(-1), Integer(68719476736), Symbol('delta')), Mul(Integer(68719476736), Symbol('skoX')), Integer(-68719031793)), Integer(0)), LessThan(Add(Mul(Integer(-1), Symbol('delta')), Pow(Symbol('skoS2'), Integer(2)), Integer(-2)), Integer(0)))
...
def post_condition(delta:sympy.Rational, skoX:sympy.Rational, skoS2:sympy.Rational, skoSP:sympy.Rational, skoSM:sympy.Rational):
	# (0 <= delta) & (1 > skoX) & (skoS2 > 0) & (skoSM > 0) & (skoSP > 0) & (skoX > 0) & (skoS2**2 - 2 <= delta) & (skoSP > -skoSM - 4) & (skoSM**2 + skoX - 1 <= delta) & (2 - skoS2**2 <= delta) & (-skoSP**2 + skoX + 1 <= delta) & (skoSP**2 - skoX - 1 <= delta) & (-skoSM**2 - skoX + 1 <= delta)
...
if __name__=="__main__":
	...
	if pre_condition_5(delta=delta,skoX=skoX,skoS2=skoS2)==True:
		...
		all_vals['skoSM'] = Add(Symbol('lambda_var_0'), Rational(23, 32))
		uv_poly_expr = get_univariate_poly(**all_vals)
		solution_exists,  lambda_val = get_lambda_val(uv_poly_expr)
	...
	if pre_condition_18(delta=delta,skoX=skoX,skoS2=skoS2)==True:
		...
		all_vals['skoX'] = skoX
		all_vals['skoS2'] = skoS2
		all_vals['skoSP'] = Add(Symbol('lambda_var_0'), Rational(370727, 262144))
		all_vals['skoSM'] = Rational(1, 512)
		uv_poly_expr = get_univariate_poly(**all_vals)
		solution_exists,  lambda_val = get_lambda_val(uv_poly_expr)
	...
	if pre_condition_19(delta=delta,skoX=skoX,skoS2=skoS2)==True:
		...
		all_vals['skoX'] = skoX
		all_vals['skoS2'] = skoS2
		all_vals['skoSP'] = Rational(370727, 262144)
		all_vals['skoSM'] = Add(Symbol('lambda_var_0'), Rational(1, 512))
		uv_poly_expr = get_univariate_poly(**all_vals)
		solution_exists,  lambda_val = get_lambda_val(uv_poly_expr)
