...
def pre_condition_0(delta:sympy.Rational,skoSINS:sympy.Rational,skoM:sympy.Rational):
	...
	pre_cond = And(GreaterThan(Symbol('delta'), Integer(0)), GreaterThan(Add(Symbol('skoM'), Integer(-2)), Integer(0)))
...
def pre_condition_1(delta:sympy.Rational,skoSINS:sympy.Rational,skoM:sympy.Rational):
	#(delta >= 0) & (skoM - 2 >= 0) & Ne(-64*delta + 64*skoSINS**2 - 63, 0) & Ne(64*delta + 64*skoSINS**2 - 63, 0) & ((-64*delta + 64*skoSINS**2 - 63 > 0) | (64*delta + 64*skoSINS**2 - 63 < 0))

	pre_cond = And(GreaterThan(Symbol('delta'), Integer(0)), GreaterThan(Add(Symbol('skoM'), Integer(-2)), Integer(0)), Unequality(Add(Mul(Integer(-1), Integer(64), Symbol('delta')), Mul(Integer(64), Pow(Symbol('skoSINS'), Integer(2))), Integer(-63)), Integer(0)), Unequality(Add(Mul(Integer(64), Symbol('delta')), Mul(Integer(64), Pow(Symbol('skoSINS'), Integer(2))), Integer(-63)), Integer(0)), Or(StrictGreaterThan(Add(Mul(Integer(-1), Integer(64), Symbol('delta')), Mul(Integer(64), Pow(Symbol('skoSINS'), Integer(2))), Integer(-63)), Integer(0)), StrictLessThan(Add(Mul(Integer(64), Symbol('delta')), Mul(Integer(64), Pow(Symbol('skoSINS'), Integer(2))), Integer(-63)), Integer(0))))
