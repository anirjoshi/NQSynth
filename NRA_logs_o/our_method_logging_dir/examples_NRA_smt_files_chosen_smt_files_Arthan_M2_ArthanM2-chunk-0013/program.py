...
def pre_condition_0(delta:sympy.Rational,skoSINS:sympy.Rational,skoM:sympy.Rational):
	#(delta - 2 >= 0) & (skoM - 2 >= 0) & (-delta + skoM <= 0) & (-delta + skoSINS**2 - 1 <= 0)

	pre_cond = And(GreaterThan(Add(Symbol('delta'), Integer(-2)), Integer(0)), GreaterThan(Add(Symbol('skoM'), Integer(-2)), Integer(0)), LessThan(Add(Mul(Integer(-1), Symbol('delta')), Symbol('skoM')), Integer(0)), LessThan(Add(Mul(Integer(-1), Symbol('delta')), Pow(Symbol('skoSINS'), Integer(2)), Integer(-1)), Integer(0)))
...
def pre_condition_1(delta:sympy.Rational,skoSINS:sympy.Rational,skoM:sympy.Rational):
	#(delta - 2 >= 0) & (skoM - 2 >= 0) & (-delta + skoM <= 0) & (-64*delta + 64*skoSINS**2 - 63 <= 0)

	pre_cond = And(GreaterThan(Add(Symbol('delta'), Integer(-2)), Integer(0)), GreaterThan(Add(Symbol('skoM'), Integer(-2)), Integer(0)), LessThan(Add(Mul(Integer(-1), Symbol('delta')), Symbol('skoM')), Integer(0)), LessThan(Add(Mul(Integer(-1), Integer(64), Symbol('delta')), Mul(Integer(64), Pow(Symbol('skoSINS'), Integer(2))), Integer(-63)), Integer(0)))
