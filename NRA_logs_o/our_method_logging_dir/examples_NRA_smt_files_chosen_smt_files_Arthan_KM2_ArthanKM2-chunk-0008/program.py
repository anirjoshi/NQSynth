...
def pre_condition_0(delta:sympy.Rational,skoS:sympy.Rational):
	#(delta - 288 >= 0) & (20*skoS - 9 > 0) & (2*skoS**2 + 4*skoS - 15 >= 0) & ((delta - 424 > 0) | (4*delta**2 - 496*delta*skoS**2 - 992*delta*skoS - 1644*delta + 2028*skoS**4 + 8112*skoS**3 + 103744*skoS**2 + 191264*skoS + 335501 > 0) | (4*delta**2*skoS**2 + 8*delta**2*skoS + 4*delta**2 - 248*delta*skoS**4 - 992*delta*skoS**3 - 2636*delta*skoS**2 - 3288*delta*skoS - 2552*delta + 676*skoS**6 + 4056*skoS**5 + 55928*skoS**4 + 196672*skoS**3 + 526765*skoS**2 + 671002*skoS + 621289 <= 0))

	pre_cond = And(GreaterThan(Add(Symbol('delta'), Integer(-288)), Integer(0)), StrictGreaterThan(Add(Mul(Integer(20), Symbol('skoS')), Integer(-9)), Integer(0)), GreaterThan(Add(Mul(Integer(2), Pow(Symbol('skoS'), Integer(2))), Mul(Integer(4), Symbol('skoS')), Integer(-15)), Integer(0)), Or(StrictGreaterThan(Add(Symbol('delta'), Integer(-424)), Integer(0)), StrictGreaterThan(Add(Mul(Integer(4), Pow(Symbol('delta'), Integer(2))), Mul(Integer(-1), Integer(496), Symbol('delta'), Pow(Symbol('skoS'), Integer(2))), Mul(Integer(-1), Integer(992), Symbol('delta'), Symbol('skoS')), Mul(Integer(-1), Integer(1644), Symbol('delta')), Mul(Integer(2028), Pow(Symbol('skoS'), Integer(4))), Mul(Integer(8112), Pow(Symbol('skoS'), Integer(3))), Mul(Integer(103744), Pow(Symbol('skoS'), Integer(2))), Mul(Integer(191264), Symbol('skoS')), Integer(335501)), Integer(0)), LessThan(Add(Mul(Integer(4), Pow(Symbol('delta'), Integer(2)), Pow(Symbol('skoS'), Integer(2))), Mul(Integer(8), Pow(Symbol('delta'), Integer(2)), Symbol('skoS')), Mul(Integer(4), Pow(Symbol('delta'), Integer(2))), Mul(Integer(-1), Integer(248), Symbol('delta'), Pow(Symbol('skoS'), Integer(4))), Mul(Integer(-1), Integer(992), Symbol('delta'), Pow(Symbol('skoS'), Integer(3))), Mul(Integer(-1), Integer(2636), Symbol('delta'), Pow(Symbol('skoS'), Integer(2))), Mul(Integer(-1), Integer(3288), Symbol('delta'), Symbol('skoS')), Mul(Integer(-1), Integer(2552), Symbol('delta')), Mul(Integer(676), Pow(Symbol('skoS'), Integer(6))), Mul(Integer(4056), Pow(Symbol('skoS'), Integer(5))), Mul(Integer(55928), Pow(Symbol('skoS'), Integer(4))), Mul(Integer(196672), Pow(Symbol('skoS'), Integer(3))), Mul(Integer(526765), Pow(Symbol('skoS'), Integer(2))), Mul(Integer(671002), Symbol('skoS')), Integer(621289)), Integer(0))))
...
if __name__=="__main__":
	...
	if pre_condition_0(delta=delta,skoS=skoS)==True:
		...
		all_vals['skoS'] = skoS
		all_vals['skoCOSS'] = Add(Symbol('lambda_var_0'), Integer(-12))
		all_vals['skoSINS'] = Integer(-17)
