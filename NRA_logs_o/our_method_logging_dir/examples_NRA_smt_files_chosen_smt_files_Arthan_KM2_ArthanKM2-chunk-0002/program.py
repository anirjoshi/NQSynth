...
def pre_condition_1(delta:sympy.Rational,skoS:sympy.Rational):
	#(delta >= 0) & (20*skoS - 9 > 0) & (skoS**6 + 6*skoS**5 - 5*skoS**4 + 150*skoS**3 + 111*skoS**2 - 452*skoS - 178 >= 0)

	pre_cond = And(GreaterThan(Symbol('delta'), Integer(0)), StrictGreaterThan(Add(Mul(Integer(20), Symbol('skoS')), Integer(-9)), Integer(0)), GreaterThan(Add(Pow(Symbol('skoS'), Integer(6)), Mul(Integer(6), Pow(Symbol('skoS'), Integer(5))), Mul(Integer(-1), Integer(5), Pow(Symbol('skoS'), Integer(4))), Mul(Integer(150), Pow(Symbol('skoS'), Integer(3))), Mul(Integer(111), Pow(Symbol('skoS'), Integer(2))), Mul(Integer(-1), Integer(452), Symbol('skoS')), Integer(-178)), Integer(0)))
...
if __name__=="__main__":
	...
	if pre_condition_0(delta=delta,skoS=skoS)==True:
		...
		all_vals['skoS'] = skoS
		all_vals['skoCOSS'] = Add(Symbol('lambda_var_0'), Integer(-15))
