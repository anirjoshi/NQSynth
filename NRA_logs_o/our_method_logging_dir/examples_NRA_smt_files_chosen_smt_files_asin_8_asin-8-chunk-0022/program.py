...
def return_post_condition_single_var(post_condition, delta:sympy.Rational=None, skoX:sympy.Rational=None, pi:sympy.Rational=None, skoSP:sympy.Rational=None):
	assert delta!=None
	assert skoX!=None
	assert pi!=None
	...
	if skoSP==None:
		return lambda skoSP: post_condition(delta=delta, skoX=skoX, pi=pi, skoSP=skoSP)


	return post_condition(delta=delta, skoX=skoX, pi=pi, skoSP=skoSP)


def get_univariate_poly( delta:sympy.Rational, skoX:sympy.Rational, pi:sympy.Rational, skoSP:sympy.Rational ):
