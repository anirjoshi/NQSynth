...
def pre_condition_0(delta:sympy.Rational,skoS:sympy.Rational,pi:sympy.Rational):
	#(delta >= 0) & (8*skoS - 1 >= 0) & (5000000*pi - 15707963 > 0) & (10000000*pi - 31415927 < 0) & (-pi + 2*skoS < 0)

	pre_cond = And(GreaterThan(Symbol('delta'), Integer(0)), GreaterThan(Add(Mul(Integer(8), Symbol('skoS')), Integer(-1)), Integer(0)), StrictGreaterThan(Add(Mul(Integer(5000000), Symbol('pi')), Integer(-15707963)), Integer(0)), StrictLessThan(Add(Mul(Integer(10000000), Symbol('pi')), Integer(-31415927)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('pi')), Mul(Integer(2), Symbol('skoS'))), Integer(0)))
