...
def pre_condition_0(delta:sympy.Rational,skoX:sympy.Rational,skoS2:sympy.Rational,pi:sympy.Rational):
	#(delta >= 0) & (skoS2 >= 0) & (pi > 15707963/5000000) & (skoX > 0) & (pi < 31415927/10000000) & (skoX < 1) & (delta + skoS2**2 >= 2) & (delta - skoS2**2 >= -2)
...
def pre_condition_1(delta:sympy.Rational,skoX:sympy.Rational,skoS2:sympy.Rational,pi:sympy.Rational):
	#(-delta <= 0) & (-skoS2 <= 0) & (-skoX < 0) & (pi - 31415927/10000000 < 0) & (skoX - 1 < 0) & (15707963/5000000 - pi < 0) & (delta - skoX - 1 < 0) & (-delta + skoS2**2 - 2 <= 0) & (-delta - skoS2**2 + 2 <= 0)

	pre_cond = And(LessThan(Mul(Integer(-1), Symbol('delta')), Integer(0)), LessThan(Mul(Integer(-1), Symbol('skoS2')), Integer(0)), StrictLessThan(Mul(Integer(-1), Symbol('skoX')), Integer(0)), StrictLessThan(Add(Symbol('pi'), Rational(-31415927, 10000000)), Integer(0)), StrictLessThan(Add(Symbol('skoX'), Integer(-1)), Integer(0)), StrictLessThan(Add(Rational(15707963, 5000000), Mul(Integer(-1), Symbol('pi'))), Integer(0)), StrictLessThan(Add(Symbol('delta'), Mul(Integer(-1), Symbol('skoX')), Integer(-1)), Integer(0)), LessThan(Add(Mul(Integer(-1), Symbol('delta')), Pow(Symbol('skoS2'), Integer(2)), Integer(-2)), Integer(0)), LessThan(Add(Mul(Integer(-1), Symbol('delta')), Mul(Integer(-1), Pow(Symbol('skoS2'), Integer(2))), Integer(2)), Integer(0)))
