...
def pre_condition_0(delta:sympy.Rational,skoX:sympy.Rational,skoS2:sympy.Rational):
	#((delta >= 0) & (skoS2 > 0) & (skoX > 0) & (skoX < 1) & (delta + skoS2**2 >= 2) & (delta - skoX < 1) & (delta - skoS2**2 >= -2)) | ((delta >= 0) & (skoS2 > 0) & (skoX > 0) & (skoX < 1) & (delta + skoS2**2 >= 2) & (delta - skoX < 3) & (delta - skoS2**2 >= -2))

	pre_cond = Or(And(GreaterThan(Symbol('delta'), Integer(0)), StrictGreaterThan(Symbol('skoS2'), Integer(0)), StrictGreaterThan(Symbol('skoX'), Integer(0)), StrictLessThan(Symbol('skoX'), Integer(1)), GreaterThan(Add(Symbol('delta'), Pow(Symbol('skoS2'), Integer(2))), Integer(2)), StrictLessThan(Add(Symbol('delta'), Mul(Integer(-1), Symbol('skoX'))), Integer(1)), GreaterThan(Add(Symbol('delta'), Mul(Integer(-1), Pow(Symbol('skoS2'), Integer(2)))), Integer(-2))), And(GreaterThan(Symbol('delta'), Integer(0)), StrictGreaterThan(Symbol('skoS2'), Integer(0)), StrictGreaterThan(Symbol('skoX'), Integer(0)), StrictLessThan(Symbol('skoX'), Integer(1)), GreaterThan(Add(Symbol('delta'), Pow(Symbol('skoS2'), Integer(2))), Integer(2)), StrictLessThan(Add(Symbol('delta'), Mul(Integer(-1), Symbol('skoX'))), Integer(3)), GreaterThan(Add(Symbol('delta'), Mul(Integer(-1), Pow(Symbol('skoS2'), Integer(2)))), Integer(-2))))
