...
def pre_condition_0(y:sympy.Rational):
	#(y**2 < 5) | Eq(1000*y**2 - 4999, 0) | ((1000*y**2 < 4999) & Eq(1000*y**2 - 4999, 0)) | ((1000*y**2 < 4999) & ((1000*y**2 < 4999) | Eq(1000*y**2 - 4999, 0)))

	pre_cond = Or(StrictLessThan(Pow(Symbol('y'), Integer(2)), Integer(5)), Equality(Add(Mul(Integer(1000), Pow(Symbol('y'), Integer(2))), Integer(-4999)), Integer(0)), And(StrictLessThan(Mul(Integer(1000), Pow(Symbol('y'), Integer(2))), Integer(4999)), Equality(Add(Mul(Integer(1000), Pow(Symbol('y'), Integer(2))), Integer(-4999)), Integer(0))), And(StrictLessThan(Mul(Integer(1000), Pow(Symbol('y'), Integer(2))), Integer(4999)), Or(StrictLessThan(Mul(Integer(1000), Pow(Symbol('y'), Integer(2))), Integer(4999)), Equality(Add(Mul(Integer(1000), Pow(Symbol('y'), Integer(2))), Integer(-4999)), Integer(0)))))
