...
def pre_condition_0(c:sympy.Rational):
	#(c < -7) | Eq(c + 7, 0) | ((c < 9) & ((-c < -17) | (c**2 + 2*c < 35) | ((-c < -17) & (-c**2 - 2*c < -35)) | ((c <= 17) & (c < 0) & Eq(c**2 + 2*c - 35, 0))))

	pre_cond = Or(StrictLessThan(Symbol('c'), Integer(-7)), Equality(Add(Symbol('c'), Integer(7)), Integer(0)), And(StrictLessThan(Symbol('c'), Integer(9)), Or(StrictLessThan(Mul(Integer(-1), Symbol('c')), Integer(-17)), StrictLessThan(Add(Pow(Symbol('c'), Integer(2)), Mul(Integer(2), Symbol('c'))), Integer(35)), And(StrictLessThan(Mul(Integer(-1), Symbol('c')), Integer(-17)), StrictLessThan(Add(Mul(Integer(-1), Pow(Symbol('c'), Integer(2))), Mul(Integer(-1), Integer(2), Symbol('c'))), Integer(-35))), And(LessThan(Symbol('c'), Integer(17)), StrictLessThan(Symbol('c'), Integer(0)), Equality(Add(Pow(Symbol('c'), Integer(2)), Mul(Integer(2), Symbol('c')), Integer(-35)), Integer(0))))))
...
def pre_condition_1(c:sympy.Rational):
	#(4*c < -1) | Eq(4*c + 1, 0) | ((64*c < 47) & ((-4*c < 1) | ((64*c < 47) & Eq(4*c + 1, 0))))

	pre_cond = Or(StrictLessThan(Mul(Integer(4), Symbol('c')), Integer(-1)), Equality(Add(Mul(Integer(4), Symbol('c')), Integer(1)), Integer(0)), And(StrictLessThan(Mul(Integer(64), Symbol('c')), Integer(47)), Or(StrictLessThan(Mul(Integer(-1), Integer(4), Symbol('c')), Integer(1)), And(StrictLessThan(Mul(Integer(64), Symbol('c')), Integer(47)), Equality(Add(Mul(Integer(4), Symbol('c')), Integer(1)), Integer(0))))))
