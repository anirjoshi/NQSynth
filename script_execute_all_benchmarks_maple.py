...
#phase 1
parser.add_argument('--our_method_logging_dir_maple', help='path of logging directory for our method', metavar='our_method_logging_dir_maple', default="our_method_logging_dir_maple", type=str)

parser.add_argument('--our_method_programs_dir_maple', help='path of logging directory for our method', metavar='our_method_programs_dir_maple', default="our_method_programs_dir_maple", type=str)
...
our_method_logging_dir = args.our_method_logging_dir_maple
our_method_programs_dir = args.our_method_programs_dir_maple
...
our_method_program = "python NQS_maple/main_tool.py"
