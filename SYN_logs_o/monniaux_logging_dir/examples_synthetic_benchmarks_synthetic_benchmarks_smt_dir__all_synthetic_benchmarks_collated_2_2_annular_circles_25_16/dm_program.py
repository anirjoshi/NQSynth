...
def pre_condition_0(y:sympy.Rational):
	#((y >= sqrt(1023)/8) | (y > -sqrt(1599)/8)) & ((y >= sqrt(1023)/8) | (y < -sqrt(1023)/8)) & ((y <= sqrt(1599)/8) | (y > -sqrt(1599)/8)) & ((y <= sqrt(1599)/8) | (y < -sqrt(1023)/8))

	pre_cond = And(Or(GreaterThan(Symbol('y'), Mul(Rational(1, 8), Pow(Integer(1023), Rational(1, 2)))), StrictGreaterThan(Symbol('y'), Mul(Integer(-1), Rational(1, 8), Pow(Integer(1599), Rational(1, 2))))), Or(GreaterThan(Symbol('y'), Mul(Rational(1, 8), Pow(Integer(1023), Rational(1, 2)))), StrictLessThan(Symbol('y'), Mul(Integer(-1), Rational(1, 8), Pow(Integer(1023), Rational(1, 2))))), Or(LessThan(Symbol('y'), Mul(Rational(1, 8), Pow(Integer(1599), Rational(1, 2)))), StrictGreaterThan(Symbol('y'), Mul(Integer(-1), Rational(1, 8), Pow(Integer(1599), Rational(1, 2))))), Or(LessThan(Symbol('y'), Mul(Rational(1, 8), Pow(Integer(1599), Rational(1, 2)))), StrictLessThan(Symbol('y'), Mul(Integer(-1), Rational(1, 8), Pow(Integer(1023), Rational(1, 2))))))
...
def pre_condition_2(y:sympy.Rational):
	#((y >= 4) | (y > -5)) & ((y >= 4) | (y < -4)) & ((y <= 5) | (y > -5)) & ((y <= 5) | (y < -4))

	pre_cond = And(Or(GreaterThan(Symbol('y'), Integer(4)), StrictGreaterThan(Symbol('y'), Integer(-5))), Or(GreaterThan(Symbol('y'), Integer(4)), StrictLessThan(Symbol('y'), Integer(-4))), Or(LessThan(Symbol('y'), Integer(5)), StrictGreaterThan(Symbol('y'), Integer(-5))), Or(LessThan(Symbol('y'), Integer(5)), StrictLessThan(Symbol('y'), Integer(-4))))
...
def pre_condition_5(y:sympy.Rational):
	#((y <= sqrt(21)) | (y > -sqrt(21))) & ((y <= sqrt(21)) | (y < -2*sqrt(3))) & ((y >= 2*sqrt(3)) | (y > -sqrt(21))) & ((y >= 2*sqrt(3)) | (y < -2*sqrt(3)))

	pre_cond = And(Or(LessThan(Symbol('y'), Pow(Integer(21), Rational(1, 2))), StrictGreaterThan(Symbol('y'), Mul(Integer(-1), Pow(Integer(21), Rational(1, 2))))), Or(LessThan(Symbol('y'), Pow(Integer(21), Rational(1, 2))), StrictLessThan(Symbol('y'), Mul(Integer(-1), Integer(2), Pow(Integer(3), Rational(1, 2))))), Or(GreaterThan(Symbol('y'), Mul(Integer(2), Pow(Integer(3), Rational(1, 2)))), StrictGreaterThan(Symbol('y'), Mul(Integer(-1), Pow(Integer(21), Rational(1, 2))))), Or(GreaterThan(Symbol('y'), Mul(Integer(2), Pow(Integer(3), Rational(1, 2)))), StrictLessThan(Symbol('y'), Mul(Integer(-1), Integer(2), Pow(Integer(3), Rational(1, 2))))))
...
def pre_condition_161(y:sympy.Rational):
	#((y <= 4) | (y > -4)) & ((y > -4) | (y >= sqrt(7))) & ((y <= 4) | (y < -sqrt(7))) & ((y >= sqrt(7)) | (y < -sqrt(7)))

	pre_cond = And(Or(LessThan(Symbol('y'), Integer(4)), StrictGreaterThan(Symbol('y'), Integer(-4))), Or(StrictGreaterThan(Symbol('y'), Integer(-4)), GreaterThan(Symbol('y'), Pow(Integer(7), Rational(1, 2)))), Or(LessThan(Symbol('y'), Integer(4)), StrictLessThan(Symbol('y'), Mul(Integer(-1), Pow(Integer(7), Rational(1, 2))))), Or(GreaterThan(Symbol('y'), Pow(Integer(7), Rational(1, 2))), StrictLessThan(Symbol('y'), Mul(Integer(-1), Pow(Integer(7), Rational(1, 2))))))
