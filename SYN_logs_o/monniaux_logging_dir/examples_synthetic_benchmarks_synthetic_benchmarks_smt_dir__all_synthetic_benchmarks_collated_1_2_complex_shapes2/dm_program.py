...
def pre_condition_0(a:sympy.Rational,r:sympy.Rational):
	#(a*y**3 - 1 < 0) & (-r + y**2 + 1/9 < 0)

	pre_cond = And(StrictLessThan(Add(Mul(Symbol('a'), Pow(Symbol('y'), Integer(3))), Integer(-1)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('r')), Pow(Symbol('y'), Integer(2)), Rational(1, 9)), Integer(0)))
...
def pre_condition_2(a:sympy.Rational,r:sympy.Rational):
	#(a*y**3 - 1/2 < 0) & (-r + y**2 + 1/16 < 0)

	pre_cond = And(StrictLessThan(Add(Mul(Symbol('a'), Pow(Symbol('y'), Integer(3))), Rational(-1, 2)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('r')), Pow(Symbol('y'), Integer(2)), Rational(1, 16)), Integer(0)))
...
def pre_condition_3(a:sympy.Rational,r:sympy.Rational):
	...
	pre_cond = And(StrictGreaterThan(Symbol('r'), Rational(5, 64)), StrictLessThan(Symbol('a'), Integer(256)))
...
def pre_condition_4(a:sympy.Rational,r:sympy.Rational):
	#(a*y**3 - 19/32 < 0) & (-r + y**2 + 289/4096 < 0)

	pre_cond = And(StrictLessThan(Add(Mul(Symbol('a'), Pow(Symbol('y'), Integer(3))), Rational(-19, 32)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('r')), Pow(Symbol('y'), Integer(2)), Rational(289, 4096)), Integer(0)))
...
def pre_condition_5(a:sympy.Rational,r:sympy.Rational):
	...
	pre_cond = And(StrictGreaterThan(Symbol('a'), Integer(-2432)), StrictGreaterThan(Symbol('r'), Rational(305, 4096)))
...
def pre_condition_6(a:sympy.Rational,r:sympy.Rational):
	#(a*y**3 - 10343/16384 < 0) & (-r + y**2 + 79370281/1073741824 < 0)

	pre_cond = And(StrictLessThan(Add(Mul(Symbol('a'), Pow(Symbol('y'), Integer(3))), Rational(-10343, 16384)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('r')), Pow(Symbol('y'), Integer(2)), Rational(79370281, 1073741824)), Integer(0)))
...
def pre_condition_7(a:sympy.Rational,r:sympy.Rational):
	#(a > -1323904/125) & (r > 81008681/1073741824)

	pre_cond = And(StrictGreaterThan(Symbol('a'), Rational(-1323904, 125)), StrictGreaterThan(Symbol('r'), Rational(81008681, 1073741824)))
...
def pre_condition_8(a:sympy.Rational,r:sympy.Rational):
	#(a*y**3 - 41/64 < 0) & (-r + y**2 + 1225/16384 < 0)

	pre_cond = And(StrictLessThan(Add(Mul(Symbol('a'), Pow(Symbol('y'), Integer(3))), Rational(-41, 64)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('r')), Pow(Symbol('y'), Integer(2)), Rational(1225, 16384)), Integer(0)))
...
def pre_condition_9(a:sympy.Rational,r:sympy.Rational):
	#(a > -20992) & (r > 1241/16384)

	pre_cond = And(StrictGreaterThan(Symbol('a'), Integer(-20992)), StrictGreaterThan(Symbol('r'), Rational(1241, 16384)))
...
def pre_condition_10(a:sympy.Rational,r:sympy.Rational):
	#(a*y**3 - 85/128 < 0) & (-r + y**2 + 5041/65536 < 0)

	pre_cond = And(StrictLessThan(Add(Mul(Symbol('a'), Pow(Symbol('y'), Integer(3))), Rational(-85, 128)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('r')), Pow(Symbol('y'), Integer(2)), Rational(5041, 65536)), Integer(0)))
...
def pre_condition_11(a:sympy.Rational,r:sympy.Rational):
	#(a > -21760) & (r > 5105/65536)

	pre_cond = And(StrictGreaterThan(Symbol('a'), Integer(-21760)), StrictGreaterThan(Symbol('r'), Rational(5105, 65536)))
...
def pre_condition_12(a:sympy.Rational,r:sympy.Rational):
	#(a*y**3 - 1363/2048 < 0) & (-r + y**2 + 1292769/16777216 < 0)

	pre_cond = And(StrictLessThan(Add(Mul(Symbol('a'), Pow(Symbol('y'), Integer(3))), Rational(-1363, 2048)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('r')), Pow(Symbol('y'), Integer(2)), Rational(1292769, 16777216)), Integer(0)))
...
def pre_condition_13(a:sympy.Rational,r:sympy.Rational):
	#(a > -21808) & (r > 1309153/16777216)

	pre_cond = And(StrictGreaterThan(Symbol('a'), Integer(-21808)), StrictGreaterThan(Symbol('r'), Rational(1309153, 16777216)))
...
def pre_condition_14(a:sympy.Rational,r:sympy.Rational):
	#(a*y**3 - 2729/4096 < 0) & (-r + y**2 + 5175625/67108864 < 0)

	pre_cond = And(StrictLessThan(Add(Mul(Symbol('a'), Pow(Symbol('y'), Integer(3))), Rational(-2729, 4096)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('r')), Pow(Symbol('y'), Integer(2)), Rational(5175625, 67108864)), Integer(0)))
...
def pre_condition_15(a:sympy.Rational,r:sympy.Rational):
	#(a > -21832) & (r > 5241161/67108864)

	pre_cond = And(StrictGreaterThan(Symbol('a'), Integer(-21832)), StrictGreaterThan(Symbol('r'), Rational(5241161, 67108864)))
...
def pre_condition_16(a:sympy.Rational,r:sympy.Rational):
	#(a*y**3 - 10919/16384 < 0) & (-r + y**2 + 82828201/1073741824 < 0)

	pre_cond = And(StrictLessThan(Add(Mul(Symbol('a'), Pow(Symbol('y'), Integer(3))), Rational(-10919, 16384)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('r')), Pow(Symbol('y'), Integer(2)), Rational(82828201, 1073741824)), Integer(0)))
...
def pre_condition_17(a:sympy.Rational,r:sympy.Rational):
	#(a > -21838) & (r > 83876777/1073741824)

	pre_cond = And(StrictGreaterThan(Symbol('a'), Integer(-21838)), StrictGreaterThan(Symbol('r'), Rational(83876777, 1073741824)))
...
def pre_condition_18(a:sympy.Rational,r:sympy.Rational):
	#(a*y**3 - 21841/32768 < 0) & (-r + y**2 + 331349209/4294967296 < 0)

	pre_cond = And(StrictLessThan(Add(Mul(Symbol('a'), Pow(Symbol('y'), Integer(3))), Rational(-21841, 32768)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('r')), Pow(Symbol('y'), Integer(2)), Rational(331349209, 4294967296)), Integer(0)))
...
def pre_condition_19(a:sympy.Rational,r:sympy.Rational):
	#(a > -21841) & (r > 335543513/4294967296)

	pre_cond = And(StrictGreaterThan(Symbol('a'), Integer(-21841)), StrictGreaterThan(Symbol('r'), Rational(335543513, 4294967296)))
...
def pre_condition_20(a:sympy.Rational,r:sympy.Rational):
	#(a*y**3 - 1397827/2097152 < 0) & (-r + y**2 + 1357208690049/17592186044416 < 0)

	pre_cond = And(StrictLessThan(Add(Mul(Symbol('a'), Pow(Symbol('y'), Integer(3))), Rational(-1397827, 2097152)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('r')), Pow(Symbol('y'), Integer(2)), Rational(1357208690049, 17592186044416)), Integer(0)))
...
def pre_condition_21(a:sympy.Rational,r:sympy.Rational):
	#(a > -1397827/64) & (r > 1374388559233/17592186044416)

	pre_cond = And(StrictGreaterThan(Symbol('a'), Rational(-1397827, 64)), StrictGreaterThan(Symbol('r'), Rational(1374388559233, 17592186044416)))
...
def pre_condition_22(a:sympy.Rational,r:sympy.Rational):
	#(a*y**3 - 5591311/8388608 < 0) & (-r + y**2 + 21715348360729/281474976710656 < 0)

	pre_cond = And(StrictLessThan(Add(Mul(Symbol('a'), Pow(Symbol('y'), Integer(3))), Rational(-5591311, 8388608)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('r')), Pow(Symbol('y'), Integer(2)), Rational(21715348360729, 281474976710656)), Integer(0)))
...
def pre_condition_23(a:sympy.Rational,r:sympy.Rational):
	#(a > -5591311/256) & (r > 21990226267673/281474976710656)

	pre_cond = And(StrictGreaterThan(Symbol('a'), Rational(-5591311, 256)), StrictGreaterThan(Symbol('r'), Rational(21990226267673, 281474976710656)))
...
def pre_condition_24(a:sympy.Rational,r:sympy.Rational):
	#(a*y**3 - 11182625/16777216 < 0) & (-r + y**2 + 86861412082809/1125899906842624 < 0)

	pre_cond = And(StrictLessThan(Add(Mul(Symbol('a'), Pow(Symbol('y'), Integer(3))), Rational(-11182625, 16777216)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('r')), Pow(Symbol('y'), Integer(2)), Rational(86861412082809, 1125899906842624)), Integer(0)))
...
def pre_condition_25(a:sympy.Rational,r:sympy.Rational):
	#(a > -11182625/512) & (r > 87960923710585/1125899906842624)

	pre_cond = And(StrictGreaterThan(Symbol('a'), Rational(-11182625, 512)), StrictGreaterThan(Symbol('r'), Rational(87960923710585, 1125899906842624)))
...
def pre_condition_26(a:sympy.Rational,r:sympy.Rational):
	#(a*y**3 - 44730503/67108864 < 0) & (-r + y**2 + 1389782667884521/18014398509481984 < 0)

	pre_cond = And(StrictLessThan(Add(Mul(Symbol('a'), Pow(Symbol('y'), Integer(3))), Rational(-44730503, 67108864)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('r')), Pow(Symbol('y'), Integer(2)), Rational(1389782667884521, 18014398509481984)), Integer(0)))
...
def pre_condition_27(a:sympy.Rational,r:sympy.Rational):
	#(a > -44730503/2048) & (r > 1407374853928937/18014398509481984)

	pre_cond = And(StrictGreaterThan(Symbol('a'), Rational(-44730503, 2048)), StrictGreaterThan(Symbol('r'), Rational(1407374853928937, 18014398509481984)))
...
def pre_condition_28(a:sympy.Rational,r:sympy.Rational):
	#(a*y**3 - 178922015/268435456 < 0) & (-r + y**2 + 22236522984390649/288230376151711744 < 0)

	pre_cond = And(StrictLessThan(Add(Mul(Symbol('a'), Pow(Symbol('y'), Integer(3))), Rational(-178922015, 268435456)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('r')), Pow(Symbol('y'), Integer(2)), Rational(22236522984390649, 288230376151711744)), Integer(0)))
...
def pre_condition_29(a:sympy.Rational,r:sympy.Rational):
	#(a > -178922015/8192) & (r > 22517997961101305/288230376151711744)

	pre_cond = And(StrictGreaterThan(Symbol('a'), Rational(-178922015, 8192)), StrictGreaterThan(Symbol('r'), Rational(22517997961101305, 288230376151711744)))
...
def pre_condition_30(a:sympy.Rational,r:sympy.Rational):
	#(a*y**3 - 357844033/536870912 < 0) & (-r + y**2 + 88946092534039225/1152921504606846976 < 0)

	pre_cond = And(StrictLessThan(Add(Mul(Symbol('a'), Pow(Symbol('y'), Integer(3))), Rational(-357844033, 536870912)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('r')), Pow(Symbol('y'), Integer(2)), Rational(88946092534039225, 1152921504606846976)), Integer(0)))
...
def pre_condition_31(a:sympy.Rational,r:sympy.Rational):
	#(a > -357844033/16384) & (r > 90071992440881849/1152921504606846976)

	pre_cond = And(StrictGreaterThan(Symbol('a'), Rational(-357844033, 16384)), StrictGreaterThan(Symbol('r'), Rational(90071992440881849, 1152921504606846976)))
