...
def pre_condition_0(y:sympy.Rational):
	#((y >= 5*sqrt(23)/8) | (y > -sqrt(1599)/8)) & ((y >= 5*sqrt(23)/8) | (y < -5*sqrt(23)/8)) & ((y <= sqrt(1599)/8) | (y > -sqrt(1599)/8)) & ((y <= sqrt(1599)/8) | (y < -5*sqrt(23)/8))

	pre_cond = And(Or(GreaterThan(Symbol('y'), Mul(Rational(5, 8), Pow(Integer(23), Rational(1, 2)))), StrictGreaterThan(Symbol('y'), Mul(Integer(-1), Rational(1, 8), Pow(Integer(1599), Rational(1, 2))))), Or(GreaterThan(Symbol('y'), Mul(Rational(5, 8), Pow(Integer(23), Rational(1, 2)))), StrictLessThan(Symbol('y'), Mul(Integer(-1), Rational(5, 8), Pow(Integer(23), Rational(1, 2))))), Or(LessThan(Symbol('y'), Mul(Rational(1, 8), Pow(Integer(1599), Rational(1, 2)))), StrictGreaterThan(Symbol('y'), Mul(Integer(-1), Rational(1, 8), Pow(Integer(1599), Rational(1, 2))))), Or(LessThan(Symbol('y'), Mul(Rational(1, 8), Pow(Integer(1599), Rational(1, 2)))), StrictLessThan(Symbol('y'), Mul(Integer(-1), Rational(5, 8), Pow(Integer(23), Rational(1, 2))))))
...
def pre_condition_1(y:sympy.Rational):
	...
	pre_cond = And(GreaterThan(Symbol('y'), Integer(-4)), LessThan(Symbol('y'), Integer(4)))
...
def pre_condition_2(y:sympy.Rational):
	#((y >= 3) | (y > -5)) & ((y >= 3) | (y < -3)) & ((y <= 5) | (y > -5)) & ((y <= 5) | (y < -3))

	pre_cond = And(Or(GreaterThan(Symbol('y'), Integer(3)), StrictGreaterThan(Symbol('y'), Integer(-5))), Or(GreaterThan(Symbol('y'), Integer(3)), StrictLessThan(Symbol('y'), Integer(-3))), Or(LessThan(Symbol('y'), Integer(5)), StrictGreaterThan(Symbol('y'), Integer(-5))), Or(LessThan(Symbol('y'), Integer(5)), StrictLessThan(Symbol('y'), Integer(-3))))
