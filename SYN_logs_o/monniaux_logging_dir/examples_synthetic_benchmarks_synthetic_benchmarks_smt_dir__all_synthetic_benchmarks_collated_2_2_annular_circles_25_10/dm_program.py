...
def pre_condition_0(y:sympy.Rational):
	#((y >= 3*sqrt(71)/8) | (y > -sqrt(1599)/8)) & ((y >= 3*sqrt(71)/8) | (y < -3*sqrt(71)/8)) & ((y <= sqrt(1599)/8) | (y > -sqrt(1599)/8)) & ((y <= sqrt(1599)/8) | (y < -3*sqrt(71)/8))

	pre_cond = And(Or(GreaterThan(Symbol('y'), Mul(Rational(3, 8), Pow(Integer(71), Rational(1, 2)))), StrictGreaterThan(Symbol('y'), Mul(Integer(-1), Rational(1, 8), Pow(Integer(1599), Rational(1, 2))))), Or(GreaterThan(Symbol('y'), Mul(Rational(3, 8), Pow(Integer(71), Rational(1, 2)))), StrictLessThan(Symbol('y'), Mul(Integer(-1), Rational(3, 8), Pow(Integer(71), Rational(1, 2))))), Or(LessThan(Symbol('y'), Mul(Rational(1, 8), Pow(Integer(1599), Rational(1, 2)))), StrictGreaterThan(Symbol('y'), Mul(Integer(-1), Rational(1, 8), Pow(Integer(1599), Rational(1, 2))))), Or(LessThan(Symbol('y'), Mul(Rational(1, 8), Pow(Integer(1599), Rational(1, 2)))), StrictLessThan(Symbol('y'), Mul(Integer(-1), Rational(3, 8), Pow(Integer(71), Rational(1, 2))))))
...
def pre_condition_2(y:sympy.Rational):
	#((y >= 3) | (y < -3)) & ((y >= 3) | (y > -2*sqrt(6))) & ((y < -3) | (y <= 2*sqrt(6))) & ((y <= 2*sqrt(6)) | (y > -2*sqrt(6)))

	pre_cond = And(Or(GreaterThan(Symbol('y'), Integer(3)), StrictLessThan(Symbol('y'), Integer(-3))), Or(GreaterThan(Symbol('y'), Integer(3)), StrictGreaterThan(Symbol('y'), Mul(Integer(-1), Integer(2), Pow(Integer(6), Rational(1, 2))))), Or(StrictLessThan(Symbol('y'), Integer(-3)), LessThan(Symbol('y'), Mul(Integer(2), Pow(Integer(6), Rational(1, 2))))), Or(LessThan(Symbol('y'), Mul(Integer(2), Pow(Integer(6), Rational(1, 2)))), StrictGreaterThan(Symbol('y'), Mul(Integer(-1), Integer(2), Pow(Integer(6), Rational(1, 2))))))
...
def pre_condition_3(y:sympy.Rational):
	#((y <= 5) | (y > -5)) & ((y > -5) | (y >= sqrt(10))) & ((y <= 5) | (y < -sqrt(10))) & ((y >= sqrt(10)) | (y < -sqrt(10)))

	pre_cond = And(Or(LessThan(Symbol('y'), Integer(5)), StrictGreaterThan(Symbol('y'), Integer(-5))), Or(StrictGreaterThan(Symbol('y'), Integer(-5)), GreaterThan(Symbol('y'), Pow(Integer(10), Rational(1, 2)))), Or(LessThan(Symbol('y'), Integer(5)), StrictLessThan(Symbol('y'), Mul(Integer(-1), Pow(Integer(10), Rational(1, 2))))), Or(GreaterThan(Symbol('y'), Pow(Integer(10), Rational(1, 2))), StrictLessThan(Symbol('y'), Mul(Integer(-1), Pow(Integer(10), Rational(1, 2))))))
...
def post_condition(y:sympy.Rational, x:sympy.Rational):
	# (0 >= x**2 + y**2 - 25) & (0 >= -x**2 - y**2 + 10)

	post_cond =  And(GreaterThan(Integer(0), Add(Pow(Symbol('x'), Integer(2)), Pow(Symbol('y'), Integer(2)), Integer(-25))), GreaterThan(Integer(0), Add(Mul(Integer(-1), Pow(Symbol('x'), Integer(2))), Mul(Integer(-1), Pow(Symbol('y'), Integer(2))), Integer(10))))
