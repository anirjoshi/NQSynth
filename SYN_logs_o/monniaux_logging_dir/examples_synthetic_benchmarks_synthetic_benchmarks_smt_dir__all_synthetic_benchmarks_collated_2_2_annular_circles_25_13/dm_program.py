...
def pre_condition_0(y:sympy.Rational):
	#((y >= sqrt(831)/8) | (y > -sqrt(1599)/8)) & ((y >= sqrt(831)/8) | (y < -sqrt(831)/8)) & ((y <= sqrt(1599)/8) | (y > -sqrt(1599)/8)) & ((y <= sqrt(1599)/8) | (y < -sqrt(831)/8))

	pre_cond = And(Or(GreaterThan(Symbol('y'), Mul(Rational(1, 8), Pow(Integer(831), Rational(1, 2)))), StrictGreaterThan(Symbol('y'), Mul(Integer(-1), Rational(1, 8), Pow(Integer(1599), Rational(1, 2))))), Or(GreaterThan(Symbol('y'), Mul(Rational(1, 8), Pow(Integer(831), Rational(1, 2)))), StrictLessThan(Symbol('y'), Mul(Integer(-1), Rational(1, 8), Pow(Integer(831), Rational(1, 2))))), Or(LessThan(Symbol('y'), Mul(Rational(1, 8), Pow(Integer(1599), Rational(1, 2)))), StrictGreaterThan(Symbol('y'), Mul(Integer(-1), Rational(1, 8), Pow(Integer(1599), Rational(1, 2))))), Or(LessThan(Symbol('y'), Mul(Rational(1, 8), Pow(Integer(1599), Rational(1, 2)))), StrictLessThan(Symbol('y'), Mul(Integer(-1), Rational(1, 8), Pow(Integer(831), Rational(1, 2))))))
...
def pre_condition_2(y:sympy.Rational):
	#((y <= 5) | (y > -5)) & ((y > -5) | (y >= sqrt(13))) & ((y <= 5) | (y < -sqrt(13))) & ((y >= sqrt(13)) | (y < -sqrt(13)))

	pre_cond = And(Or(LessThan(Symbol('y'), Integer(5)), StrictGreaterThan(Symbol('y'), Integer(-5))), Or(StrictGreaterThan(Symbol('y'), Integer(-5)), GreaterThan(Symbol('y'), Pow(Integer(13), Rational(1, 2)))), Or(LessThan(Symbol('y'), Integer(5)), StrictLessThan(Symbol('y'), Mul(Integer(-1), Pow(Integer(13), Rational(1, 2))))), Or(GreaterThan(Symbol('y'), Pow(Integer(13), Rational(1, 2))), StrictLessThan(Symbol('y'), Mul(Integer(-1), Pow(Integer(13), Rational(1, 2))))))
...
def pre_condition_4(y:sympy.Rational):
	#((y >= 2*sqrt(3)) | (y > -2*sqrt(6))) & ((y >= 2*sqrt(3)) | (y < -2*sqrt(3))) & ((y <= 2*sqrt(6)) | (y > -2*sqrt(6))) & ((y <= 2*sqrt(6)) | (y < -2*sqrt(3)))

	pre_cond = And(Or(GreaterThan(Symbol('y'), Mul(Integer(2), Pow(Integer(3), Rational(1, 2)))), StrictGreaterThan(Symbol('y'), Mul(Integer(-1), Integer(2), Pow(Integer(6), Rational(1, 2))))), Or(GreaterThan(Symbol('y'), Mul(Integer(2), Pow(Integer(3), Rational(1, 2)))), StrictLessThan(Symbol('y'), Mul(Integer(-1), Integer(2), Pow(Integer(3), Rational(1, 2))))), Or(LessThan(Symbol('y'), Mul(Integer(2), Pow(Integer(6), Rational(1, 2)))), StrictGreaterThan(Symbol('y'), Mul(Integer(-1), Integer(2), Pow(Integer(6), Rational(1, 2))))), Or(LessThan(Symbol('y'), Mul(Integer(2), Pow(Integer(6), Rational(1, 2)))), StrictLessThan(Symbol('y'), Mul(Integer(-1), Integer(2), Pow(Integer(3), Rational(1, 2))))))
...
def pre_condition_6(y:sympy.Rational):
	#((y >= 2) | (y > -4)) & ((y >= 2) | (y < -2)) & ((y <= 4) | (y > -4)) & ((y <= 4) | (y < -2))

	pre_cond = And(Or(GreaterThan(Symbol('y'), Integer(2)), StrictGreaterThan(Symbol('y'), Integer(-4))), Or(GreaterThan(Symbol('y'), Integer(2)), StrictLessThan(Symbol('y'), Integer(-2))), Or(LessThan(Symbol('y'), Integer(4)), StrictGreaterThan(Symbol('y'), Integer(-4))), Or(LessThan(Symbol('y'), Integer(4)), StrictLessThan(Symbol('y'), Integer(-2))))
