...
def post_condition(r1:sympy.Rational, r2:sympy.Rational, x:sympy.Rational, y:sympy.Rational):
	# (0 > -r1 + x**12 + y**12) & (0 > r2 - x**12 - y**12)

	post_cond =  And(StrictGreaterThan(Integer(0), Add(Mul(Integer(-1), Symbol('r1')), Pow(Symbol('x'), Integer(12)), Pow(Symbol('y'), Integer(12)))), StrictGreaterThan(Integer(0), Add(Symbol('r2'), Mul(Integer(-1), Pow(Symbol('x'), Integer(12))), Mul(Integer(-1), Pow(Symbol('y'), Integer(12))))))
