...
def pre_condition_0(c:sympy.Rational,d:sympy.Rational):
	...
	pre_cond = And(StrictGreaterThan(Symbol('d'), Integer(0)), StrictGreaterThan(Add(Symbol('c'), Symbol('d')), Integer(0)))
...
def pre_condition_1(c:sympy.Rational,d:sympy.Rational):
	...
	pre_cond = And(StrictGreaterThan(Symbol('c'), Integer(0)), Or(StrictGreaterThan(Symbol('d'), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Symbol('c')), Pow(Symbol('d'), Integer(2))), Integer(0))))
...
def pre_condition_2(c:sympy.Rational,d:sympy.Rational):
	...
	pre_cond = And(StrictGreaterThan(Add(Mul(Integer(2), Symbol('d')), Integer(1)), Integer(0)), StrictGreaterThan(Add(Mul(Integer(4), Symbol('c')), Mul(Integer(4), Symbol('d')), Integer(1)), Integer(0)))
...
def pre_condition_3(c:sympy.Rational,d:sympy.Rational):
	#(64*c + 25 > 0) & ((64*d - 25 > 0) | (-4096*c + 4096*d**2 - 3200*d - 975 < 0))

	pre_cond = And(StrictGreaterThan(Add(Mul(Integer(64), Symbol('c')), Integer(25)), Integer(0)), Or(StrictGreaterThan(Add(Mul(Integer(64), Symbol('d')), Integer(-25)), Integer(0)), StrictLessThan(Add(Mul(Integer(-1), Integer(4096), Symbol('c')), Mul(Integer(4096), Pow(Symbol('d'), Integer(2))), Mul(Integer(-1), Integer(3200), Symbol('d')), Integer(-975)), Integer(0))))
...
if __name__=="__main__":
	...
	if pre_condition_2(c=c,d=d)==True:
		...
		all_vals['c'] = c
		all_vals['d'] = d
		all_vals['x'] = Add(Symbol('lambda_var_0'), Rational(-5, 8))
