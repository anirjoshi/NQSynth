...
def post_condition(r1:sympy.Rational, r2:sympy.Rational, x:sympy.Rational, y:sympy.Rational):
	# (0 > -x) & (0 > r2 + x*y + y) & (0 > -r1 + x - y**2)

	post_cond =  And(StrictGreaterThan(Integer(0), Mul(Integer(-1), Symbol('x'))), StrictGreaterThan(Integer(0), Add(Symbol('r2'), Mul(Symbol('x'), Symbol('y')), Symbol('y'))), StrictGreaterThan(Integer(0), Add(Mul(Integer(-1), Symbol('r1')), Symbol('x'), Mul(Integer(-1), Pow(Symbol('y'), Integer(2))))))
