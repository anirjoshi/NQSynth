...
def indent(mixed_string, start, nesting_count):
    print("INDENT:", start, mixed_string)
...
#    print("parse_intput1.ast", ast)
    ...
    return python_condition, parser.vars

def write_program(pre_condition_sympy, sygus_synthesized_function_file, ip_vars, op_vars, output_program_name):
    print("_________________________________________")
    print("PRE_CONDITION_SYMPY:", pre_condition_sympy)
    print("sygus_synthesized_function_file:", sygus_synthesized_function_file)
    print("IP_VARS:", ip_vars)
    print("OP_VARS:",op_vars)
    ...
    for INPUT_2 in INPUT_3:
        ...
        # try:
        if len(body_code_cleaned)> 1:
           nLines,indented_code = indent(body_code_cleaned,0,1)
        else:
            assert len(body_code_cleaned) == 1
            nLines, indented_code = 1, "    return" + " "  + body_code_cleaned[0]
        # except:
        #     pass
        # print("____________________")
...
def main():
    ...
    #Or ( y_i**2 - 25 <= 0 )
    #Or (delta_i < 0, skoX_i > 0, skoS2_i<= 0)
...
#    print("condition_main:", condition)
    ...
    for input_var in input_vars:
        code_lines.append(f"{input_var} = input()\n")
